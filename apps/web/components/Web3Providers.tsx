...
/**
 * Wallet providers — static imports (reliable).
 * Async module-loading previously left the whole shell on "Loading wallet…"
 * forever when a chunk timed out or React Strict Mode cancelled the effect.
 */
