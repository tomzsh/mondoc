...
/** Full scanner UI — loaded async from the /scan route shell. */
            ...
            {approvalsError && (
              <div className="ui-card break-words border-danger/30 bg-danger/5 p-4 text-sm text-danger">
                <p className="font-semibold">
                  Scan failed:{" "}
                  {(approvalsError as Error).message?.includes(
                    "HTTP request failed",
                  )
